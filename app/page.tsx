...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-center p-2 sm:p-4 md:p-8 transition-colors duration-200 overflow-y-hidden sm:overflow-y-auto">
